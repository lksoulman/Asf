...
const
  ...
  ASF_COMMAND_ID_USERATTENTIONMGR          = 50000005;
  ASF_COMMAND_ID_USERPOSITIONCATEGORYMGR   = 50000006;
...
//  ASF_COMMAND_ID_WEBEMBED_
  ...
  // AsfUI.dll {}
  ASF_COMMAND_ID_SECTORTREE                = 80030001;
  ASF_COMMAND_ID_USERPOSITIONSET           = 80030002;

  // AsfUI.dll
  ASF_COMMAND_ID_SECTORPRICEHQ             = 80040001;
