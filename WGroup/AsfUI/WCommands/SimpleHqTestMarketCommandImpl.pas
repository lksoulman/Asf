unit SimpleHqTestMarketCommandImpl;

////////////////////////////////////////////////////////////////////////////////
//
// Description£º SimpleHqTestMarketCommand Implementation
// Author£º      lksoulman
// Date£º        2017-12-15
// Comments£º
//
...
type
  ...
  // SimpleHqTestMarketCommand Implementation
  TSimpleHqTestMarketCommandImpl = class(TCommandImpl)
  private
  protected
  public
    // Constructor
...
{ TSimpleHqTestMarketCommandImpl }

constructor TSimpleHqTestMarketCommandImpl.Create(AId: Cardinal; ACaption: string; AContext: IAppContext);
begin
  inherited;

end;

destructor TSimpleHqTestMarketCommandImpl.Destroy;
begin

  inherited;
end;

procedure TSimpleHqTestMarketCommandImpl.Execute(AParams: string);
var
  LHandle: Integer;
